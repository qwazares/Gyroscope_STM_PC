...
#define I_AM_L3GD20                 ((uint8_t)0xD4)		/* device ID */
...
/*********************** READ WRITE ****************************/
#define L3GD20_WRITE              ((uint8_t)0x00)
#define L3GD20_READ               ((uint8_t)0x80)

#define L3GD20_MULTIPLE_RW        ((uint8_t)0x40)	//auto-incrementation of address
#define L3GD20_SINGLE_RW          ((uint8_t)0x00)
...
typedef struct
{
	...
	uint8_t endian_data;
	uint8_t high_pass_filter_status;
	uint8_t high_pass_filter_mode;
	uint8_t high_pass_cutoff_frequency;
	uint8_t int1_status;
	uint8_t int2_status;
	uint8_t int1_active_edge;
	uint8_t boot_mode;
